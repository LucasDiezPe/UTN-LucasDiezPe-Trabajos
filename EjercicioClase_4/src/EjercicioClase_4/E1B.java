...
public class E1B {
	...
	int a,b,c;
	System.out.println("Ingresar por consola 3  numeros separados por un espacio");
	String orden;
	...
	System.out.println( "Indicar ingresando una letra si se los quiere ordenados de manera (a) "
			+ "ascendente o (d) descendente acontinuación");
	...
	System.out.println("El orden descendente :"+descendente[0]+" "+descendente[1]+" "+descendente[2]);}
	else if (orden.equalsIgnoreCase("a")) {
	System.out.println("El orden ascendente de los numeros es:"+ascendente[0]+" "+ascendente[1]+" "+ascendente[2]+"  ");}
	else {System.out.println("ha ingresado un dato erroneo vuelva a comenzar el programa");
	}
	IngDatos.close();
	}
}